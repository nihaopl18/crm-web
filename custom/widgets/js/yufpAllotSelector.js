...
(function(vue, $, name) {
    ...
    vue.component(name, {
        template: '<div>\
            ...
            <el-dialog-x title="机构用户管理" :visible.sync= "dialogVisible" :height="height" :width = "width">\
            <el-row :gutter="20">\
            ...
            getDefaultData: function() {
                ...
                return {
                    ...
                    user: {
                        ...
                        dataUrl: backend.appOcaService + '/api/util/getuser',
                        dataParams: {
                            roleId: '',
                            dutyId: '',
                            orgCode: yufp.session.org.code
