        ...
        props: {
            ...
            toolbar: {
                ...
                default: function() {
                    ...
                    return [
                        'removeformat undo redo |  bullist numlist | outdent indent | forecolor | fullscreen code',
                        'bold italic blockquote | h2 p | image media | alignleft aligncenter alignright | table'
                    ];
                }
            },
            menubar: {
        ...
        methods: {
            init: function() {
                ...
                window.tinymce.init({
                    ...
                    language: 'zh_CN',
                    plugins: 'advlist,autolink,code,paste,textcolor, colorpicker,fullscreen,link,lists,media,wordcount,image,imagetools,table',
                    ...
                    images_upload_handler: function(blobInfo, success, failure) {
                        ...
                        xhr.timeout = 200000;
                        // var url = yufp.service.getUrl({url: '/zuul' + backend.fileService + _this.action});
                        var url = yufp.service.getUrl({ url: backend.fileService + _this.action }); // 单体
                        xhr.open('POST', url);
                        ...
                        xhr.onload = function() {
                            ...
                            // success(path);
                            var path = yufp.service.getUrl({ url: backend.fileService + '/api/file/provider/download?fileId=' + json.data.filePath });
