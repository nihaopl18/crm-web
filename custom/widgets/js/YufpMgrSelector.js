...
(function(vue, $, name) {
    ...
    vue.component(name, {
        template: '<div>\
            ...
            :data-url="user.dataUrl" :base-params="user.userBaseParam" :table-columns="user.tableColumns" :default-load="false"></el-table-x>\
            </el-col>\
            </el-row>\
        ...
        methods: {
            ...
            confirmFn: function() {
                var me = this;
                var curuserId = yufp.session.userId;
                ...
                if (data[0].userId == curuserId && me.knowledgeisno) {
                    this.$message('客户经理不能选择自己!', '提示');
                    return;
                }
