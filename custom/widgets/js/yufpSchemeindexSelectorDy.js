            ...
            getDefaultData: function () {
                ...
                return {
                    ...
                    user: {
                        ...
                        load: true, // 不默认查询
                        dataUrl: backend.appBaseService + '/api/pmafschemeindexrel/querySchemeAndIndex',
                        dataParams: {
                        },
                        tableColumns: [
                            { label: '指标编号', prop: 'indexId', width: '', resizable: true },
                            { label: '指标名称', prop: 'indexName', width: '', resizable: true },
                            { label: '余额类型', prop: 'balTypeId', width: '', dataCode: 'YE_TYPE', resizable: true },
                            { label: '应用类型', prop: 'applyTypeId', width: '', dataCode: 'INDEX_APPLY_TYPE', resizable: true },
                            { label: '考核对象', prop: 'evlObjType', width: '', dataCode: 'OBJ', resizable: true }
                        ]
                    }
                };
            },
...
}(Vue, yufp.$, 'yufp-schemeindex-selector-dy'));