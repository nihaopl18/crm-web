...
(function(vue, $, name) {
    ...
    vue.component(name, {
        template: '<div>\
            ...
            <el-row :gutter="20">\
            <el-col :span="5">\
            <yufp-ext-tree ref="orgtree" :show-checbox="false" :checkStrictly="org.checkStrictly" :defaultExpandAll="org.defaultExpandAll"\
            ...
            :data-url="duty.dataUrl" :base-params="duty.dataParams"\
            ...
            getDefaultData: function() {
                ...
                return {
                    ...
                    duty: {
                        ...
                        dataUrl: backend.appOcaService + '/api/util/getduty',
                        dataParams: {
                            orgCode: yufp.session.org.code
                        },
                        tableColumns: [{
