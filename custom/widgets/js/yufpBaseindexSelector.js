 ...
 */
(function (vue, $, name) {
  yufp.lookup.reg('LOGIC_TYPE,INDEX_YW_TYPE');
  // 注册用户组件
  vue.component(name, {
    template: '<div>\
           ...
           <el-dialog-x title="基础指标选择器" :visible.sync= "dialogVisible" :height="height" :width = "width">\
           <el-row :gutter="20">\
      ...
      getDefaultData: function () {
        ...
        return {
          ...
          user: {
            ...
            maxHeight: maxHeight,
            fieldData: [
              { placeholder: '基础指标编号', field: 'indexId', type: 'input'},
              { placeholder: '基础指标名称', field: 'indexName', type: 'input'}
            ],
            buttons: [{
              label: '搜索',
              op: 'submit',
            ...
            tableColumns: [
              ...
              { label: '指标类型', prop: 'indexType', width: '', resizable: true, dataCode: 'LOGIC_TYPE'},
              { label: '指标业务类型', prop: 'bussType', width: '', resizable: true, dataCode: 'INDEX_YW_TYPE'}
            ]
          }
        };
      },
        ...
        handler: function (val) {
          ...
          if (val == '' || val == null) {
            ...
            yufp.service.request({
              url: backend.appBaseService + '/api/pmafschemeindexrel/querynamesbydash',
              method: 'get',
              data: { objId: val },
...
}(Vue, yufp.$, 'yufp-baseindex-selector'));