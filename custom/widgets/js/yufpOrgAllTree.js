  ...
  vue.component(name, {
    ...
    methods: {
      ...
      createData: function () {
        ...
        if (me.params.dataParams === 'oneorg') {
          yufp.service.request({
            ...
            callback: function (code, message, response) {
              if (code == 0) {
                temp.dataParams = {
                  condition: JSON.stringify({orgCode: response.data.oneOrg})
                };
              }
            }
          });
          ...
          temp.dataParams = {
            condition: JSON.stringify({orgCode: me.params.dataParams})
          };
        }
      ...
      getDefaultData: function () {
        return {
          ...
          // 数据参数
          dataParams: {
            condition: JSON.stringify({orgCode: yufp.session.org.code})
          },
          searchType: 'CUR_ORG', // 所辖或者当前""
          tempNodekeys: [],
          tempTreeData: [],
          dataUrl: backend.appOcaService + '/api/allcust/getorgtree'
        };
      }
    },
    watch: {
