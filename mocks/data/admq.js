define([
  './mocks/data/orgTreeData.js',
  './mocks/data/orgOrgTree.js',
  './mocks/data/roleByUser.js',
  './mocks/data/userData.js',
  './mocks/data/modelDelayDetails.js',
  './mocks/data/dutyByUser.js'
  ...
  exports.getModelDelayDetails = function () {
    ;
    return {
      total: modelDelayDetails.length,
      data: modelDelayDetails
    };
  };
});