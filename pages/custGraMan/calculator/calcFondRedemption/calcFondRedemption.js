/**
 * @created by 张成龙 on 2019-1-25 15:42:27
 * @updated by
 * @description 基金赎回计算器
 */
 ...
 * 计算方法
        */ calc: function (condtion) {
          ...
          var resultMoney2;
          var resultMoney3;
          resultMoney1 = parseFloat(condtion.param1) * parseFloat(condtion.param2);
          // resultMoney2 = resultMoney1 - (resultMoney1 / (1 + (parseFloat(condtion.param3) * 0.01)));
          resultMoney2 = resultMoney1 * parseFloat(condtion.param3) * 0.01;
