/**
 * @created by 张成龙 on 2019-1-25 16:18:36
 * @updated by
 * @description 基金定投计算器
 */
 ...
 * 计算方法
        */ calc: function (condtion) {
          ...
          var resultMoney3;
          var resultMoney4;
          var syl = parseFloat(condtion.param3) * 0.01;

          resultMoney1 = parseFloat(condtion.param1) * parseFloat(condtion.param2) * 12;
          resultMoney3 = parseFloat(condtion.param1) * 12 * (1 + syl) * [Math.pow(1 + syl, parseFloat(condtion.param2)) - 1] / syl;
          resultMoney2 = resultMoney3 - resultMoney1;
          resultMoney4 = resultMoney2 / resultMoney1 * 100;
          var from = {};
