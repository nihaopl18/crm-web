/**
 * @created by 张成龙 on 2019-1-24 15:09:02
 * @updated by
 * @description 理财认购计算器
 */
 ...
 * 计算方法
        */ calc: function (condtion) {
          var _this = this;
          var resultMoney = (Number(condtion.param1) * Number(condtion.param2) * Number(condtion.param3) * 0.01) / Number(condtion.param4);
          var from = {};
          from.resultMoney1 = resultMoney.toFixed(4);
