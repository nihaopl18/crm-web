            ...
            methods: {
                ...
                createLkType: function() {
                    ...
                    if (this.currentTypeId == null) {
                        vm.$message({ message: '请选择目录节点!', type: 'warning' })
                        return false;
                    }
                ...
                updateLkItem: function() {
                    ...
                    this.$nextTick(function() {
                        this.$refs.lookupItemForm.formModel = yufp.extend({}, this.filterGrid.currentItemRow);
                    });
                    this.lkItemDialogVisible = true;
                },
                //新增目录保存
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                yufp.util.butLogInfo(hashCode, '数据字典配置', '新增目录');
                            } else {
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                //刷新树
                                vm.$refs.lookuptypetree.remoteData();
                                yufp.util.butLogInfo(hashCode, '数据字典配置', '修改目录');
                            } else {
                                vm.$message({ message: '保存失败!' })
                            }
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                yufp.util.butLogInfo(hashCode, '数据字典配置', '新增内容目录');
                            } else {
                                vm.$message({ message: '保存失败!' })
                            }
                        }
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                var param = {
                                    ...
                                    //刷新树
                                vm.$refs.itemTable.remoteData(param);
                                yufp.util.butLogInfo(hashCode, '数据字典配置', '修改内容目录');
                            } else {
                                vm.$message({ message: '保存失败!' })
                            }
                ...
                deleteLkType: function() {
                    ...
                    vm.$confirm('确认删除该类别目录以及目录下的类别?', '提示', {
                        ...
                        yufp.service.request({
                            url: backend.appCommonService + '/api/adminsmlookuptype/deletes/' + lookupTypeId,
                            method: 'post',
                            data: {
                            ...
                            callback: function(code, message, response) {
                                if (code == '0') {
                                    ...
                                    yufp.util.butLogInfo(hashCode, '数据字典配置', '删除类别目录');
                            ...
                            callback: function(code, message, response) {
                                if (code == '0') {
                                    ...
                                    var param = {
                                        ...
                                        //刷新树
                                    vm.$refs.itemTable.remoteData(param);
                                    yufp.util.butLogInfo(hashCode, '数据字典配置', '删除内容目录');
                                } else {
                                    vm.$message({ message: '删除失败!' })
                                }
                            }
                ...
                lookuptableEditFn: function() {
                    ...
                    this.$nextTick(function() {
                        ...
                        this.$refs.datafilterForm.formModel = yufp.extend({}, this.filterGrid.currentRow);
                    });
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                vm.queryInitFn();
                                yufp.util.butLogInfo(hashCode, '数据字典配置', '修改字典类别');
                            } else {
                        ...
                        callback: function(code, message, response) {
                            ...
                            if (code == '0') {
                                if (response.code == '2000') {
                                    ...
                                    vm.$message({ message: '保存成功!' });
                                    vm.queryInitFn();
                                    yufp.util.butLogInfo(hashCode, '数据字典配置', '新增字典类别');
                                }
                            } else {
                                vm.$message({ message: '保存失败!' });
                            }
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                if (code == '0') {
                                    ...
                                    vm.queryInitFn();
                                    vm.$refs.itemTable.remoteData();
                                    yufp.util.butLogInfo(hashCode, '数据字典配置', '删除数据字典类别');
                                } else {
                                    vm.$message({ message: '删除失败!' });
                                }
                            }
                ...
                dataFiltermultDeleteFn: function() {
                        ...
                        vm.$confirm('确认删除该字典类别以及类别下的字典内容?', '提示', {
                            ...
                            yufp.service.request({
                                url: backend.appCommonService + '/api/adminsmLookup/deletes/' + vm.filterGrid.currentRow.lookupId,
                                method: 'post',
                                data: {
                                    lookupId: vm.filterGrid.currentRow.lookupId
                                },
                                callback: function(code, message, response) {
                                    if (code == '0') {
                                        vm.$message({ message: '删除成功!' });
                                        vm.queryInitFn();
                                        vm.$refs.itemTable.remoteData();
                                        yufp.util.butLogInfo(hashCode, '数据字典配置', '批量删除数据字典类别');
                                    } else {
                                        vm.$message({ message: '删除失败!' });
                                    }
                                }
