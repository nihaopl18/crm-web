...
define(
    ...
    function(require, exports) {
        ...
        exports.ready = function(hashCode, data, cite) {
            ...
            var queryUrl = backend.jobService + '/api/adminjoblog/querypagebyid?jobId=' + data;
            vm = yufp.custom.vue({
                el: cite.el,
                data: function() {
                    var me = this;
                    return {
                        ...
                        queryButtons: [{
                                ...
                                click: function(model, valid) {
                                    ...
                                    me.mainGrid.dataUrl = backend.jobService + "/api/adminjoblog/querypage",
                                        me.queryMainGridFn();
                                }
                            },
                            ...
                            this.$confirm('此操作将删除该日志, 是否继续?', '提示', {
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function(code, message, response) {
                                        ...
                                        vue.queryMainGridFn();
                                        yufp.util.butLogInfo(hashCode, '调度日志', '删除日志');
                                    }
                                });
                            })
                        } else {
                        ...
                        this.$confirm('此操作将终止该任务, 是否继续?', '提示', {
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    ...
                                    vue.queryMainGridFn()
                                    yufp.util.butLogInfo(hashCode, '调度日志', '终止任务');
                                }
                            });
                        })
                    }
        ...
        exports.onmessage = function(type, message) {
            if (type === "msg") {
                vm.mainGrid.dataUrl = backend.jobService + '/api/adminjoblog/querypagebyid?jobId=' + message;
            }
