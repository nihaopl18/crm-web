                            ...
                            click: function(model, valid) {
                                if (valid) {
                                    ...
                                    if (param.length == 0) {
                                        ...
                                        me.$refs.filterTable.remoteData({ condition: JSON.stringify(param) });
                                    }
                                }
                            }
                        },
                    ...
                    updateFields: [{
                        ...
                        fields: [{
                            ...
                            },
                            {
                                ...
                                label: '备注',
                                type: 'textarea',
                                rules: [{ max: 950, message: '输入值过长', trigger: 'blur' }]
                            }
                        ]
                    }],
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                yufp.util.butLogInfo(hashCode, '系统参数', '修改系统参数');
                            } else {
                    ...
                    yufp.service.request({
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                vm.$refs.filterTable.remoteData();
                                yufp.util.butLogInfo(hashCode, '系统参数', '新增系统参数');
                            } else {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                if (code == '0') {
                                    ...
                                    vm.$refs.filterTable.remoteData();
                                    yufp.util.butLogInfo(hashCode, '系统参数', '批量删除系统参数');
                                } else {
