        ...
        var vm = yufp.custom.vue({
            ...
            data: function() {
                ...
                return {
                    ...
                    treeUrl: backend.appOcaService + '/api/adminsmorg/orgtreequery?orgId=' + yufp.session.org.code + '&orgSts=A',
                    queryFields: [
                    ...
                    mainGrid: {
                        ...
                        tableColumns: [{
                                ...
                                <a onclick="return false;" href="javascipt:void(0);" style="text-decoration:underline;" @click="_$event(\'custom-detail-click\', scope)">{{ scope.row.orgName }}</a>\
                            </template>';
                                }
                            },
                    ...
                    updateFields: [{
                        ...
                        fields: [{
                            ...
                            },
                            {
                                ...
                                is: 'yufp-org-tree',
                                params: {
                                    dataUrl: backend.appOcaService + '/api/adminsmorg/orgtreequery?orgId=' + yufp.session.org.code + '&orgSts=A',
                                    dataId: 'orgCode',
                                    needCheckbox: false
                                },
                                rules: [
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function(code, message, response) {
                                        if (response.data.code === '2') {
                                            ...
                                            yufp.util.butLogInfo(hashCode, '机构管理', '新增成功');
                                            me.queryMainGridFn();
                                            // me.refreshOrgTree();
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function(code, message, response) {
                                        if (response.data.code === '2') {
                                            ...
                                            me.dialogFormVisible = false;
                                            me.$message({ message: '数据保存成功！' });
                                            yufp.util.butLogInfo(hashCode, '机构管理', '修改成功');
                                            me.queryMainGridFn();
                                            me.$refs.mytree.remoteData();
                                        }
                                    }
                        ...
                        me.$confirm('此操作将启用该数据, 是否继续?', '提示', {
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    ...
                                    yufp.util.butLogInfo(hashCode, '机构管理', '启用成功');
                                    me.queryMainGridFn();
                                    me.$refs.mytree.remoteData();
                                }
                            });
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == 0) {
                                        ...
                                        yufp.util.butLogInfo(hashCode, '机构管理', '停用成功');
                                        me.queryMainGridFn();
                                        me.$refs.mytree.remoteData();
                                    }
                                }
