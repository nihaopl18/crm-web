...
define([
        ...
        './custom/widgets/js/yufpCronEditor.js' // cron编辑器
    ],
    function(require, exports) {
        ...
        exports.ready = function(hashCode, data, cite) {
            ...
            yufp.service.request({
                method: 'GET',
                url: backend.jobService + '/api/triggergroup/querypage',
                data: {
                    condition: JSON.stringify({ 'pageable': false })
                },
            ...
            var vm = yufp.custom.vue({
                ...
                data: function() {
                    ...
                    return {
                        ...
                        jobInfoTableUrl: backend.jobService + '/api/xxljobinfo/pagelist',
                        ...
                        tableColumns: [{
                            ...
                            },
                            {
                                ...
                                <a onclick="return false;" href="javascipt:void(0);" style="text-decoration:underline;" @click="_$event(\'custom-detail-click\', scope)">{{ scope.row.jobDesc }}</a>\
                            </template>';
                                }
                            },
                ...
                methods: {
                    ...
                    addFn: function() {
                        ...
                        this.$nextTick(function() {
                            this.$refs.jobInfoForm.resetFn();
                            // 新增页面进入修改子任务查询id
                            var temp = yufp.clone(this.updateFields[0].fields[7].params);
                            temp.dataUrl = backend.jobService + '/api/xxljobinfo/childjoblist';
                            ...
                            this.$refs.jobInfoForm.rebuildFn();
                    ...
                    modifyFn: function() {
                        ...
                        this.$nextTick(function() {
                            ...
                            var temp = yufp.clone(this.updateFields[0].fields[7].params);
                            temp.dataUrl = backend.jobService + '/api/xxljobinfo/childjoblist?jobId=' + jobId;
                            this.updateFields[0].fields[7].params = yufp.clone(temp);
                            // 设置编号不可编辑
                            ...
                            if (jobHandler != 'BEAN') {
                                ...
                                this.updateFields[0].fields[5].rules[0].required = false;
                            } else {
                                this.$refs.jobInfoForm.switch('executorHandler', 'disabled', false);
                                this.updateFields[0].fields[5].rules[0].required = true;
                            }
                    ...
                    infoFn: function(row) { // 详情弹出方法
                        ...
                        var selectedData = yufp.clone(row.row);
                        // 子任务id反显汉字
                        var childJobId = selectedData.childJobid;
                        var rawValue = '';
                        if (childJobId != null) {
                            var childids = childJobId.split(',');
                            var data = this.$refs.jobInfoTable.data;
                        ...
                        selectedData.childJobid = rawValue;
                        this.$nextTick(function() {
                            yufp.extend(this.$refs.jobInfoForm.formModel, selectedData);
                        });
                    },
                    // 新增保存
                    saveCreateFn: function() {
                        ...
                        this.$refs.jobInfoForm.validate(function(valid) {
                            if (valid) {
                                yufp.service.request({
                                    method: 'POST',
                                    url: backend.jobService + '/api/xxljobinfo/add',
                                    data: commitData,
                                    callback: function(code, message, response) {
                                        if (response.code == 200) {
                                            ...
                                            vue.queryMainGridFn();
                                            yufp.util.butLogInfo(hashCode, '任务管理', '新增任务');
                                        } else {
                    ...
                    saveEditFn: function() {
                        ...
                        this.$refs.jobInfoForm.validate(function(valid) {
                            if (valid) {
                                yufp.service.request({
                                    method: 'POST',
                                    url: backend.jobService + '/api/xxljobinfo/reschedule',
                                    ...
                                    callback: function(code, message, response) {
                                        if (response.code == 200) {
                                            ...
                                            vue.$message({ message: '数据保存成功！' });
                                            vue.queryMainGridFn();
                                            yufp.util.butLogInfo(hashCode, '任务管理', '修改');
                                        } else {
                                            vue.$message({ message: response.msg, type: 'warning' });
                                        }
                                    }
                    ...
                    deleteFn: function() {
                        ...
                        vue.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                            ...
                            yufp.service.request({
                                method: 'POST',
                                url: backend.jobService + '/api/xxljobinfo/remove?id=' + id,
                                callback: function(code, message, response) {
                                    vue.$message({ message: '数据删除成功！' });
                                    vue.queryMainGridFn();
                                    yufp.util.butLogInfo(hashCode, '任务管理', '删除');
                                }
                            });
                        }).catch(function() {
                            return;
                    ...
                    triggerFn: function() {
                        ...
                        vue.$confirm('确认执行?', '提示', {
                            ...
                            yufp.service.request({
                                method: 'POST',
                                url: backend.jobService + '/api/xxljobinfo/trigger?id=' + id,
                                callback: function(code, message, response) {
                                    vue.$message({ message: '执行成功！' });
                                    vue.queryMainGridFn();
                                    yufp.util.butLogInfo(hashCode, '任务管理', '执行');
                                }
                            });
                        }).catch(function() {
                            return;
                    ...
                    suspendFn: function() {
                        ...
                        this.$confirm('确认暂停?', '提示', {
                            ...
                            yufp.service.request({
                                method: 'POST',
                                url: backend.jobService + '/api/xxljobinfo/pause?id=' + id,
                                callback: function(code, message, response) {
                                    vue.$message({ message: '暂停成功！' });
                                    vue.queryMainGridFn();
                                    yufp.util.butLogInfo(hashCode, '任务管理', '暂停');
                                }
                            });
                        }).catch(function() {
                            return;
                    ...
                    recoveryFn: function() {
                        ...
                        this.$confirm('确认恢复?', '提示', {
                            ...
                            yufp.service.request({
                                method: 'POST',
                                url: backend.jobService + '/api/xxljobinfo/resume?id=' + id,
                                callback: function(code, message, response) {
                                    vue.$message({ message: '恢复成功！' });
                                    vue.queryMainGridFn();
                                    yufp.util.butLogInfo(hashCode, '任务管理', '恢复');
                                }
                            });
                        }).catch(function() {
                            return;
                    ...
                    openLogFn: function() {
                        ...
                        var row = this.$refs.jobInfoTable.selections[0];
                        var id = row.id;
                        yufp.router.sendMessage('0e81b99414cb4041ae753b4d19bae7e4', 'msg', id);
                        // 打开菜单页签
                        yufp.frame.addTab({
                    ...
                    initGetCode: function() {
                        ...
                        yufp.service.request({
                            method: 'GET',
                            url: backend.jobService + '/api/xxljobcode/getJobInfo',
                            data: {
                                jobId: row.id
                            },
                            callback: function(code, message, response) {
                    ...
                    saveNewCode: function() {
                        ...
                        yufp.service.request({
                            method: 'POST',
                            url: backend.jobService + '/api/xxljobcode/save',
                            data: {
                                id: row.id,
