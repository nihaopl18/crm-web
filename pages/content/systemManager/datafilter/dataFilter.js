        ...
        var vm = yufp.custom.vue({
            ...
            methods: {
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                ...
                                if (response.code == '100000') {
                                    ...
                                    yufp.util.butLogInfo(hashCode, '数据权限模板', '修改');
                                }
                            } else {
                        ...
                        callback: function(code, message, response) {
                            if (code == '0') {
                                if (response.code == '100000') {
                                    ...
                                    vm.$refs.filterTable.remoteData();
                                    yufp.util.butLogInfo(hashCode, '数据权限模板', '新增');
                                }
                            } else {
                ...
                dataFiltermultDeleteFn: function() {
                    ...
                    vm.$confirm('删除模版将会删除其数据权限引用以及授权关系，确认批量删除数据权限模板?请谨慎操作!', '提示', {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                if (code == '0') {
                                    ...
                                    vm.$refs.filterTable.remoteData();
                                    yufp.util.butLogInfo(hashCode, '数据权限模板', '删除');
                                } else {
