                    ...
                    modTableColumns: [{
                        ...
                        template: function() {
                            return '<template scope="scope">\
                                <a onclick="return false;" href="javascipt:void(0);" style="text-decoration:underline;" @click="_$event(\'custom-row-click\', scope)">{{ scope.row.modName }}</a>\
                            </template>';
                        }
                    }],
                    funcTableColumns: [{
                            ...
                            template: function() {
                                return '<template scope="scope">\
                                <a onclick="return false;" href="javascipt:void(0);" style="text-decoration:underline;" @click="_$event(\'custom-row-click\', scope)">{{ scope.row.funcName }}</a>\
                            </template>';
                            }
                        },
                        {
                                    ...
                                    if (response.data.length > 0) {
                                        ...
                                        yufp.service.request({
                                            ...
                                            callback: function(code, message, response) {
                                                ...
                                                yufp.util.butLogInfo(hashCode, '业务功能管理', '模块管理新增');
                                            }
                                        });
                                    }
                                }
                                        ...
                                        yufp.service.request({
                                            ...
                                            callback: function(code, message, response) {
                                                if (code == '0' && response.code == 0) {
                                                    ...
                                                    _this.$message({ message: '数据保存成功！' });
                                                    _this.$refs.modTable.remoteData();
                                                    yufp.util.butLogInfo(hashCode, '业务功能管理', '模块管理修改');
                                                }
                                            }
                                        });
                                    }
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == '0' && response.code == 0) {
                                        ...
                                        yufp.util.butLogInfo(hashCode, '业务功能管理', '业务功能管理新增');
                                    }
                                }
                            });
                        } else {
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == '0' && response.code == 0) {
                                        ...
                                        _this.$refs.funcTable.remoteData(param);
                                        yufp.util.butLogInfo(hashCode, '业务功能管理', '业务功能管理修改');
                                    }
                                }
                            });
                        } else {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                if (code == '0' && response.code == 0) {
                                    ...
                                    _this.$refs.modTable.remoteData({});
                                    yufp.util.butLogInfo(hashCode, '业务功能管理', '模块管理删除');
                                } else {
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == '0' && response.code == 0) {
                                        ...
                                        _this.$refs.funcTable.remoteData(param);
                                        yufp.util.butLogInfo(hashCode, '业务功能管理', '业务功能管理删除');
                                    }
                                }
                            });
                        }).catch(function() {
