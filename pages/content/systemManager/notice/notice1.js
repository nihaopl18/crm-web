...
define([
  ...
  exports.ready = function (hashCode, data, cite) {
    ...
    var dataparam;
    if (Notice) {
      dataparam = { reciveOgjId: yufp.session.org.id,
    ...
    var vm = yufp.custom.vue({
      ...
      data: function () {
        ...
        return {
          a: '',
          // 公告查询URL
          serviceUrl: backend.adminService + '/api/cimfmmloginfo/',
          // 角色列表URL
          ...
          updateFields: [
            ...
            },
            {
              ...
              fields: [
                ...
                {
                  field: 'activeDate', label: '有效时间', type: 'date', pickerOptions: 'datePick'
                },
                {
                  field: 'isTop', label: '是否置顶', type: 'select', dataCode: 'TOP_FLAG', value: 'N', rules: [{required: true, message: '必填项', trigger: 'blur'}]
                },
                {
                  field: 'topActiveDate', label: '置顶期至', type: 'date', pickerOptions: 'datePick'
                },
                {
                  field: 'reciveOrgId',
                  label: '接收机构',
