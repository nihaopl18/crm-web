                  ...
                  dutyCde: fields.formModel.dutyCde
                    ...
                    yufp.service.request({
                      ...
                      callback: function (code, message, response) {
                        ...
                        yufp.util.butLogInfo(hashCode, '岗位管理', '新增成功');
                        vue.queryMainGridFn();
                      }
                    });
                  }
            ...
            if (valid) {
              yufp.service.request({
                ...
                callback: function (code, message, response) {
                  vue.dialogVisible = false;
                  vue.$message({message: '数据保存成功！'});
                  yufp.util.butLogInfo(hashCode, '岗位管理', '修改成功');
                  vue.queryMainGridFn();
                }
              });
            }
            ...
            this.$confirm('此操作将所选岗位生效, 是否继续?', '提示', {
              ...
              yufp.service.request({
                ...
                callback: function (code, message, response) {
                  ...
                  yufp.util.butLogInfo(hashCode, '岗位管理', '生效成功');
                                  vue.queryMainGridFn();
                }
              });
            });
              ...
              type: 'warning',
                ...
                data: {
                  ...
                  if (code == 0) {
                                      ...
                                      yufp.util.butLogInfo(hashCode, '岗位管理', '失效成功');
                                      vue.queryMainGridFn();
                  }
                }
              });
                      ...
                      method: 'POST',
                        ...
                        id: id
                                          ...
                                          callback: function (code, message, response) {
                                              ...
                                              yufp.util.butLogInfo(hashCode, '岗位管理', '删除成功');
                        vue.queryMainGridFn();
                      }
                    });
                  });
