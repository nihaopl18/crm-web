                ...
                return {
                    ...
                    updateFields: [{
                        ...
                        fields: [
                            ...
                            { field: 'isCycle', label: '是否循环', calcDisabled: false, type: 'select', dataCode: 'YESNO' },
                            {
                                field: 'cachevalue',
                                label: '缓存值',
                                readonly: false,
                    ...
                    updateOtherFields: [{
                        ...
                        fields: [{
                            ...
                            row: 1,
                            maxlength: 100,
                            placeholder: "双击变量表格实现快速序列模板格式配置",
                            rules: [
                                { required: true, message: '必填项', trigger: 'blur' }
                            ]
                        }]
                        ...
                        fields: [{
                            ...
                            { field: 'zeroFill', label: '不足位数是否用0补全', type: 'select', dataCode: 'YESNO' }
                        ]
                    }],
                    tableData: [
                        ...
                        this.$confirm('此操作将删除该数据记录, 是否继续?', '提示', {
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    ...
                                    vue.queryFn();
                                    yufp.util.butLogInfo(hashCode, '序列号模板', '删除');
                                }
                            });
                        })
                    } else {
                    ...
                    if (this.$refs.seqconfigTable.selections.length == 1) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                ...
                                yufp.util.butLogInfo(hashCode, '序列号模板', '创建序列');
                            }
                        });
                    } else {
                ...
                deleteSeqFn: function() { //删除序列
                    if (this.$refs.seqconfigTable.selections.length == 1) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                vue.$message({ message: response.message });
                                yufp.util.butLogInfo(hashCode, '序列号模板', '删除序列');
                            }
                        });
                    } else {
                ...
                resetSeqFn: function() { //重置序列
                    if (this.$refs.seqconfigTable.selections.length == 1) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                vue.$message({ message: response.message });
                                yufp.util.butLogInfo(hashCode, '序列号模板', '重置序列');
                            }
                        });
                    } else {
                    ...
                    if (this.$refs.seqconfigTable.selections.length == 1) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                ...
                                yufp.util.butLogInfo(hashCode, '序列号模板', '生成序列');
                            }
                        });
                    } else {
                    ...
                    if (formFlag && otherFormFlag) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                ...
                                vue.queryFn();
                                yufp.util.butLogInfo(hashCode, '序列号模板', '修改');
                            }
                        });
                    }
                },
