            ...
            tableColumns: [
              {
                ...
                template: function () {
                  return '<template scope="scope">\
                                <a style="text-decoration:underline;" @click="_$event(\'custom-detail-click\', scope)">{{ scope.row.instuName }}</a>\
                            </template>';
                }
              }, {
                label: '金融机构代码',
            ...
            yufp.service.request({
              ...
              callback: function (code, message, response) {
                if (response.data.code == '2') {
                  ...
                  vue.queryFn();
                  yufp.util.butLogInfo(hashCode, '金融机构管理', '新增成功');
                }
              }
            });
          } else {
          ...
          if (formFlag && otherFormFlag) {
            ...
            yufp.service.request({
              ...
              callback: function (code, message, response) {
                ...
                me.queryFn();
                yufp.util.butLogInfo(hashCode, '金融机构管理', '修改成功');
              }
            });
          } else {
            this.$message({
            ...
            this.$confirm('此操作将启用该数据, 是否继续?', '提示', {
              ...
              yufp.service.request({
                ...
                callback: function (code, message, response) {
                  ...
                  vue.queryFn();
                  yufp.util.butLogInfo(hashCode, '金融机构管理', '启用成功');
                }
              });
            });
          } else {
              ...
              yufp.service.request({
                ...
                callback: function (code, message, response) {
                  if (code == 0) {
                    ...
                    vue.queryFn();
                    yufp.util.butLogInfo(hashCode, '金融机构管理', '停用成功');
                  }
                }
              });
            });
              ...
              yufp.service.request({
                ...
                callback: function (code, message, response) {
                  if (response != null && response.data != null) {
                    ...
                    vue.queryFn();
                    yufp.util.butLogInfo(hashCode, '金融机构管理', '删除成功');
                  }
                }
              });
            });
