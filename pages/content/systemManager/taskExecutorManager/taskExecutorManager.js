            ...
            data: function() {
                ...
                return {
                    ...
                    mainGrid: {
                        ...
                        checkbox: true,
                        dataUrl: backend.jobService + '/api/triggergroup/querypage?sort=orderCode asc',
                        paging: {
                            page: 1,
                            size: 10
                        },
            ...
            methods: {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                if (response.code == 100000) {
                                    ...
                                    vue.queryFn();
                                    yufp.util.butLogInfo(hashCode, '调度日志', '新增');
                                }
                    ...
                    if (formFlag) {
                        ...
                        yufp.service.request({
                            ...
                            callback: function(code, message, response) {
                                ...
                                me.queryFn();
                                yufp.util.butLogInfo(hashCode, '调度日志', '修改');
                            }
                        });
                ...
                deletestFn: function() { //删除
                    if (this.$refs.infotable.selections.length == 1) {
                        ...
                        yufp.service.request({
                            method: 'POST',
                            url: backend.jobService + "/api/triggergroup/checkdelete/" + id,
                            callback: function(code, message, response) {
                                if (response.data == 0) {
                                    vue.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                                        ...
                                        yufp.service.request({
                                            method: 'POST',
                                            url: backend.jobService + "/api/triggergroup/delete/" + id,
                                            callback: function(code, message, response) {
                                                if (response.data < 1) {
                                                ...
                                                vue.queryFn();
                                                yufp.util.butLogInfo(hashCode, '执行器管理', '删除');
                                            }
                                        });
                                    })
                                } else {
