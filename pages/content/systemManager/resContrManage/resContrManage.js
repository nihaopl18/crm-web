        ...
        var vm = yufp.custom.vue({
                    ...
                    pointQueryButtons: [{
                            ...
                            click: function(model, valid) {
                                if (valid) {
                                    var param = model;
                                    // 添加左边树的参数
                                    param.funcId = me.funcId ? me.funcId : null;
                                    var _param = { condition: param };
                                    me.$refs.pointTable.remoteData(_param);
                                }
                            }
                        },
            ...
            methods: {
                ...
                nodeClickFn: function(nodeData, node, self) {
                    ...
                    var _param = {};
                    yufp.extend(_param, _this.$refs.pointQuery.fm);
                                        ...
                                        yufp.service.request({
                                            ...
                                            callback: function(code, message, response) {
                                                if (code == '0' && response.code == 0) {
                                                    ...
                                                    _this.$refs.pointTable.remoteData(param);
                                                    yufp.util.butLogInfo(hashCode, '控制点管理', '新增');
                                                }
                                            }
                                        });
                                    }
                                        ...
                                        yufp.service.request({
                                            ...
                                            callback: function(code, message, response) {
                                                if (code == '0' && response.code == 0) {
                                                    ...
                                                    _this.$refs.pointTable.remoteData(param);
                                                    yufp.util.butLogInfo(hashCode, '控制点管理', '修改');
                                                }
                                            }
                                        });
                                    }
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == '0' && response.code == 0) {
                                        ...
                                        _this.$refs.pointTable.remoteData(param);
                                        yufp.util.butLogInfo(hashCode, '控制点管理', '删除');
                                    }
                                }
                            });
                        });
