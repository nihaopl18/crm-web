            ...
            var vm = yufp.custom.vue({
                ...
                data: function () {
                    ...
                    return {
                        ...
                        orgTreeUrl: backend.appOcaService + "/api/util/getorg?userId=" + yufp.session.userId + "&orgCode=" + yufp.session.org.code,
                ...
                methods: {
                            ...
                            if (valid) {
                                yufp.service.request({
                                    ...
                                    callback: function (code, message, response) {
                                        if (response > 0) {
                                            me.$message({message: '该部门编号重复,请修改！', type: 'warning'});
                                        } else {
                                            yufp.service.request({
                                                method: 'POST',
                                                ...
                                                callback: function (code, message, response) {
                                                    ...
                                                    yufp.util.butLogInfo(hashCode, '部门管理', '新增');
                                                    me.queryMainGridFn();
                                                }
                                            });
                                        }
                            ...
                            if (valid) {
                                yufp.service.request({
                                    ...
                                    callback: function (code, message, response) {
                                        me.dialogVisible = false;
                                        me.$message({message: '数据保存成功！'});
                                        yufp.util.butLogInfo(hashCode, '部门管理', '修改');
                                        me.queryMainGridFn()
                                    }
                                });
                            }
                        ...
                        if (this.$refs.dptTable.selections.length > 0) {
                            ...
                            this.$confirm('此操作将所选部门生效, 是否继续?', '提示', {
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function (code, message, response) {
                                        me.$message({message: response.data});
                                        me.queryMainGridFn();
                                        yufp.util.butLogInfo(hashCode, '部门管理', '生效');
                                    }
                                });
                            })
                        } else {
                            me.$message({message: '请先选择要生效的数据', type: 'warning'});
                            return;
                        }
                    },
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function (code, message, response) {
                                        if(code==0){
                                            ...
                                            me.queryMainGridFn();
                                            yufp.util.butLogInfo(hashCode, '部门管理', '失效');
                                        }
                                    }
                                });
                            });
                    ...
                    deleteFn: function () {//批量删除
                        ...
                        if (this.$refs.dptTable.selections.length > 0) {
                            ...
                            me.$confirm('此操作将删除该部门信息, 是否继续?', '提示', {
                                confirmButtonText: '确定',
                                cancelButtonText: '取消',
                                type: 'warning',
                                center: true
                                ...
                                yufp.service.request({
                                    ...
                                    callback: function (code, message, response) {
                                        if (code == '0' && response.code == 0) {
                                            me.$message({message: response.data.message});
                                            me.queryMainGridFn();
                                            yufp.util.butLogInfo(hashCode, '部门管理', '删除');
                                        }
                                    }
                                });
                            }).catch(function () {
