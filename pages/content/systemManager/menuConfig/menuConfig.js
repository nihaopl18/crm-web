            ...
            var vm = yufp.custom.vue({
                ...
                data: function() {
                    ...
                    return {
                        ...
                        menuTreeUrl: backend.appOcaService + '/api/adminsmmenu/menutreequery?sysId=' + yufp.session.logicSys.id,
                                            ...
                                            yufp.service.request({
                                                ...
                                                callback: function(code, message, response) {
                                                    if (code == '0' && response.code == 0) {
                                                        ...
                                                        yufp.util.butLogInfo(hashCode, '菜单配置', '新增');
                                                    }
                                                }
                                            });
                                            me.addFlag = false;
                                            ...
                                            yufp.service.request({
                                                ...
                                                callback: function(code, message, response) {
                                                    if (code == '0' && response.code == 0) {
                                                        ...
                                                        me.$refs.menuForm.formModel.funcId = '';
                                                        delete me.$refs.menuForm.formModel.menuId;
                                                        yufp.util.butLogInfo(hashCode, '菜单配置', '修改');
                                                    }
                                                }
                                            });
                                        }
                            ...
                            yufp.service.request({
                                ...
                                callback: function(code, message, response) {
                                    if (code == '0' && response.code == 0) {
                                        ...
                                        yufp.util.butLogInfo(hashCode, '菜单配置', '删除');
                                    }
                                }
                            });
                        });
