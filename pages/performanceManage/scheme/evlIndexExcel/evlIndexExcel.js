...
define([
  ...
  exports.ready = function (hashCode, data, cite) {
    ...
    yufp.custom.vue({
      ...
      data: function () {
        return {
          dataUrl: backend.appBaseService + '/api/pmafevlindexexcelinfo/querylist',
          formdata: {},
          rule: [
      ...
      methods: {
        ...
        saveFn: function () {
          ...
          yufp.service.request({
            method: 'POST',
            url: backend.appBaseService + '/api/pmafevlindexexcelinfo/addorupdate',
            data: model,
          ...
          _this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            callback: function (action) {
              if (action === 'confirm') {
                yufp.service.request({
                  method: 'POST',
                  url: backend.appBaseService + '/api/pmafevlindexexcelinfo/del',
                  data: arr.join(','),
                  callback: function (code, message, response) {
                    _this.$refs.refTable.remoteData();
                    _this.$message('操作成功');
