        ...
        yufp.custom.vue({
            ...
            data: function () {
                ...
                return {
                    ...
                    tabName: 'customer',
                    tableColumns: [
                        // { label: '对象类型', prop: 'objType', width: 110, headerAlign: 'center', dataCode: 'ASSEMBLY_OBJ_TYPE' },
                        // { label: '指标名称', ctype: 'input', prop: 'targetId', width: 110, headerAlign: 'center' }
                    ],
                    addColumns: [],
                    par: '',
                    tabdata: [],
                    ...
                    callback: function (code, message, response) {
                        if (code == 0 && response.data.length > 0) {
                            ...
                            _this.tableColumns.push({
                                label: '指标名称', ctype: 'input', prop: 'targetId', width: 110, headerAlign: 'center',
                                children: [
                                    { label: '指标名称', ctype: 'yufp-target-selector', prop: 'targetId0', width: 110 },
                                    { label: '期初值', prop: 'sta0', width: 110, ctype: 'input' },
                                    { label: '目标值', prop: 'tar0', width: 110, ctype: 'input' }
                                ]
                            });
                    ...
                    for (var i = 0; i < col.length; i++) {
                        ...
                        if (element.children && element.children.length > 0) {
                            ...
                            for (var d = 0; d < element.children.length; d++) {
                                ...
                                // chi.ctype = 'yufp-target-selector'
                            }
                        } else {
