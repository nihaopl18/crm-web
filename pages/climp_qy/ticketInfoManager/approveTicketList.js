...
define(['libs/yufp/widgets/js/YufpWfInit.js'], function (require, exports) {
  ...
  exports.ready = function (hashCode, data, cite) {
    yufp.lookup.reg('TICKET_TYPE,RECEIVE_TYPE,DATA_STS,WF_APP_STATUS');
    ...
    yufp.custom.vue({
      ...
      mounted: function () {
        ...
        yufp.service.request({
          method: 'GET',
          url: backend.qyPoolService + '/api/loyqyvirtticket/detail?id=' + data.bizSeqNo,
