/**
 * @Created by taoting1 taoting1@yusys.com.cn on 2019-1-24 15:25:35.
 * @updated by
 * @description 个人客户视图
 */
define(function (require, exports) {
  ...
  exports.ready = function (hashCode, data, cite) {
    ...
    var custData = data.cust;
    // powerLev === '4' 如果是授权
    if (custData.powerLev === '4') {
      var vurl = backend.adminService + '/api/ocrmfsysviewauth/qrygrantlist';
      // TODO所辖客户查询页面跳转过来时，带的客户经理id的字段是什么
      var reparam = {custId: custId, mgrId: custData.belongMgr };
    } else {
      var vurl = backend.adminService + '/api/ocrmfsysviewauth/selectviewtree';
      var reparam = { loginCode: yufp.session.userCode, sysId: yufp.session.logicSys.id };
    }
    yufp.custom.vue({
      el: cite.el,
      data: function () {
        ...
        */
        getTreeDataFn: function (originalData) {
          ...
          this.$nextTick(function () {
            ...
            this.$refs.refTree.data[0] && this.$refs.refTree.data[0].children && this.$refs.refTree.data[0].children[0] && this.routeToFn(this.$refs.refTree.data[0].children[0]);
          });
        }, /**
        * 树结构数据加载完成
        */
        ...
        */
        routeToFn: function (obj) {
          ...
          _this.$nextTick(function () {
            ...
            try {
              yufp.router.to(routeId, {id: obj.viewItemId, custId: custId, custName: custName}, _this.viewPageId);
            } catch (error) {
