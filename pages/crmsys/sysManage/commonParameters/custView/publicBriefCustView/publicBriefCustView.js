    ...
    yufp.custom.vue({
      ...
      data: function () {
        return {
          ...
          // 进入树节点筛选if判断的次数
          index: 1,
          // 页面间传递的参数——{id: 视图在视图树中的节点id，custId： 客户号， custName： 客户名称}
          transData: data,
          showTree: false
        };
      },
        ...
        */
        routeToFn: function (obj) {
          ...
          _this.$nextTick(function () {
            ...
            try {
              yufp.router.to(routeId, {id: obj.viewItemId, custId: _this.transData.custId, custName: _this.custName}, _this.viewPageId);
            } catch (error) {
