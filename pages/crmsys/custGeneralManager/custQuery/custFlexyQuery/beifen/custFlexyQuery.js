...
*/
                ...
                if (response.data) {
                  ...
                  if (custStatus === 'Q1' || custStatus === 'Q2') {
                    ...
                    yufp.frame.addTab({
                      ...
                      title: '客户视图:' + selections[0].custNameBase, // 页签名称
                      data: {
        ...
        //   if (num > 0 && num != 1) {
        //     vm.$message({ message: '请先选择一条客户群类型为手动添加或者模板导入的客户群', type: 'warning' });
        //     return;
        //   }
        //   var istrue;
        ...
        //     async: false,
        //     callback: function (code, message, response) {
        //       if (response.data[0].custOrigin == '1') { // 判断客户来源是否为手动添加或者模板导入
        //         istrue = true;
        //       } else {
        //         vm.$message({ message: '请先选择一条客户来源为手动添加的客户群', type: 'warning' });
        //         istrue = false;
        //       }
        //     }
        //   });
