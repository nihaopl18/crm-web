  ...
  */
  exports.ready = function (hashCode, data, cite) {
    ...
    yufp.custom.vue({
      ...
      data: function () {
        return {
          refDataUrl: backend.adminService + '/api/mkt/cmmonitor',
          proDataUrl: backend.adminService + '/api/mkt/cmmonitorrelation',
          sucDataUrl: backend.adminService + '/api/mkt/cmmonitorsuccess',
