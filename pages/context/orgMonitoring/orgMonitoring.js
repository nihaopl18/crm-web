/**
 * @Created by zhanghan zhanghan3@yusys.com.cn on 2018-12-18 15:10:23.
 * @description 机构监控
 */
 define([
    ...
    yufp.custom.vue({
      ...
      data: function () {
        ...
        return {
          ...
          tableColumns: [
            { label: '所属机构', prop: 'belongOrg', width: 110, dataCode: 'NATIONALITY', hidden: true },
          ...
          selectFlag: true,
          dataUrl: backend.adminService + '/api/orgmonitoring/list',
          impUrl: backend.adminService + '/api/orgmonitoring/getIiplist',
          successUrl: backend.adminService + '/api/orgmonitoring/getsuccesslist',
          failedUrl: backend.adminService + '/api/orgmonitoring/getfailedlist',
          impIngVisible: false,
