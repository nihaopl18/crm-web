      ...
      $this.find('li').each(function () {
        ...
        if ($.navMenu.isParent($thisChild)) {
          ...
          if (!opts.openClick) {
            $(this).bind({
              mouseenter: function () {
                $.navMenu.show($ul, opts)
                ;
              },
              mouseleave: function () {
                $.navMenu.hide($ul, opts)
                ;
              }
            });
          } else {
            $(this).bind({
              click: function (e) {
                e.preventDefault(); $.navMenu.show($ul, opts)
                ;
              },
              mouseleave: function () {
                $.navMenu.hide($ul, opts);
...
(function ($) {
  $.tileMenu = {
        ...
        if ($.tileMenu.isParent($a)) {
          ...
          if (!opts.openClick) {
            ...
            $(this).bind({click: function (e) {
              e.preventDefault(); $.tileMenu.show($box);
            },
            mouseleave: function () {
                $.tileMenu.hide($box)
              ;
      ...
      $this.find('span').each(function () {
        ...
        if ($.tileMenu.isParent($_this)) {
          ...
          $_this.bind('click', function (e) {
            e.preventDefault(); $_this.toggleClass('ck');
          });
        }
      });
      $this.find('a:not(.firstLevel)').each(function () {
        $(this).bind('click', function () {
          $(this).parents('.yu-topTileMenus').fadeOut('fast');
        });
      });
    },
    show: function (el) {
    ...
    isParent: function (el) {
      return !!(el.next().is('div') || el.next().is('ul'));
    }
  };
