    ...
    function createNavMenu (menus) {
      ...
      for (var i = 0; i < menus.length; i++) {
        ...
        if (menu.children && menu.children.length > 0) {
          domStr += '<li><a href="javascript:void(0);" title="' + menu.mText + '">' + menu.mText + '</a>';
          ...
          if (menu.isIndex) {
            ...
            domStr += '<li><a href="javascript:void(0);" class="yu-isMenu ck" data-mId="' + menu.mId + '" data-key="' + indexDateKey + '" data-url="' + menu.routeId + '" title="' + menu.mText + '">' + menu.mText + '</a></li>';
          } else {
