...
define([
    ...
    exports.ready = function (hashCode, data, cite) {
        var vm = yufp.custom.vue({
            ...
            methods: {
                ...
                queryEvenFn: function () {
                    var me = this;
                    // console.log("页码，大小："+param.page+","+param.size);
                    var param = {
        ...
        setCharts = function () {
            //客户指标
            var customerChartBox = echarts.init(document.getElementById('customerChartBox1'));
            var customerOption = {
                tooltip: {
                    show: false
                },
            ...
            //零售客户
            var retailClientChartBox = echarts.init(document.getElementById('retailClientChartBox1'));
            ...
            //客户等级提升
            var userGradeChartBox = echarts.init(document.getElementById('userGradeChartBox1'));
            var userGradeOption = {
                tooltip: {
                    show: false
                },
            ...
            // 客户星级升级数-对公客户
            var publicUpgradeChartBox = echarts.init(document.getElementById('publicUpgradeChartBox1'));
            ...
            // 客户星级升级数-零售客户
            var retailUpgradeChartBox = echarts.init(document.getElementById('retailUpgradeChartBox1'));
            ...
            //存款规模
            var depositsChartBox = echarts.init(document.getElementById('depositsChartBox1'));
            var depositsOption = {
                title: {
                    show: false
                },
            ...
            //贷款余额
            var loansChartBox = echarts.init(document.getElementById('loansChartBox1'));
            var loansOption = {
                title: {
                    show: false
                },
            ...
            //贷款中收
            var zShouChartBox = echarts.init(document.getElementById('zShouChartBox1'));
            var zShouOption = {
                title: {
                    show: false
                },
            ...
            //营销活动
            var marketingChartBox = echarts.init(document.getElementById('marketingChartBox1'));
            var marketingOption = {
                title: {
                    show: false
                },
            ...
            // 待分配任务
            var assignTaskChartBox = echarts.init(document.getElementById('assignTaskChartBox1'));
            ...
            //客户等级分布  
            var gradeDistributeChartBox = echarts.init(document.getElementById('gradeDistributeChartBox1'));
            ...
            //商机转化率
            var convertRatioChartBox = echarts.init(document.getElementById('convertRatioChartBox1'));
            ...
            var publicDistributeChartBox = echarts.init(document.getElementById('publicDistributeChartBox1'));
            ...
            var retailDistributeChartBox = echarts.init(document.getElementById('retailDistributeChartBox1'));
