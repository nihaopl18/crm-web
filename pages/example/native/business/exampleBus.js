            ...
            var bus = yufp.custom.vue({
                ...
                data: function () {
                    ...
                    return {
                        height: 160,
                        content: 'Tinymce',
                        action: yufp.util.addTokenInfo(backend.fileService + "/api/file/provider/uploadfile"),
                        orgTree: {
                            editFields: [{
                                columnCount: 1,
                                fields: [{
                            ...
                            buttons: [{
                                ...
                                click: function (model, valid) {
                                    ...
                                    if (me.first) {
                                        temp.dataUrl = backend.fileService + "/api/util/getdpt";
                                        temp.dataId = "orgCode";
                                        me.first = false;
                                    } else {
                                        temp.dataUrl = backend.fileService + "/api/util/getorgtree";
                                        temp.dataId = "orgId";
                                        me.first = true;
                                    }
                ...
                methods: {
                    saveFn: function () {
                        ...
                        upload({
                            url: backend.fileService+"/api/file/provider/uploadfile",
                            data:data,
                    ...
                    downloadFile:function(){
                        yufp.util.download(backend.fileService + "/api/file/provider/download?fileId=group1/M00/00/02/wKj7l1phW0WAblgGAAAKlRuVZDc599.jpg");
                    },
                    setFn: function () {
                    ...
                    upload: function () {
                        var me = this;
                        var url = backend.appCommonService + "/api/log/exportasync";
                        ...
                        yufp.service.request({
                            url: backend.appCommonService + "/api/log/exportasync",
                            method: "get",
                            callback: function (code, message, response) {
                                if (response != null) {
                                    yufp.service.request({
                                        url: backend.fileService + "/api/util/io/querytaskinfo?taskId=" + response,
                                        method: "get",
                                        callback: function (code, message, response) {
