          ...
          "span",
          {
            ...
            on: {
              ...
              mouseleave: function($event) {
                $event.stopPropagation()
                return _vm.resetCurrentValue($event)
              },
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    texts: {
      type: Array,
      default: function _default() {
        return [Object(locale_["t"])('el.rate.texts1'), Object(locale_["t"])('el.rate.texts2'), Object(locale_["t"])('el.rate.texts3'), Object(locale_["t"])('el.rate.texts4'), Object(locale_["t"])('el.rate.texts5')];
      }
    },
    textTemplate: {
      type: String,
  ...
  computed: {
    text: function text() {
      ...
      if (this.disabled) {
        ...
        // 最大值比较大，且多个显示同一文本
        result = this.texts[Math.ceil(this.currentValue / (this.max / this.texts.length || 1)) - 1];
      }
      return result;
    },
