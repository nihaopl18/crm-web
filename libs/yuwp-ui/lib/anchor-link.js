...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/anchor/src/anchor-link.vue?vue&type=template&id=285187d1&
var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      this.anchorCom.showInk && this.anchorCom.fillFullInk
        ? _c("i", { staticClass: "el-anchor__ink__ball" })
        : _vm._e(),
      _c(
        "span",
        {
          ...
          attrs: {
            route: _vm.route,
            "data-scroll-offset": _vm.scrollOffset,
            "data-route": _vm.route,
            title: _vm.title
          },
          on: {
...
// CONCATENATED MODULE: ./packages/anchor/src/anchor-link.vue?vue&type=template&id=285187d1&
...
/* harmony default export */ var anchor_linkvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      prefix: 'el-anchor__link'
    };
  },

  computed: {
    anchorLinkClasses: function anchorLinkClasses() {
      return [this.prefix, this.anchorCom.currentLink === this.route ? this.prefix + '__active' : ''];
    },
  ...
  methods: {
    goAnchor: function goAnchor() {
      ...
      var sharpLinkMatch = assist_["sharpMatcherRegx"].exec(this.route);
      if (!sharpLinkMatch) return;
      this.anchorCom.currentLink = sharpLinkMatch[0];
      this.anchorCom.currentId = sharpLinkMatch[1];
      this.anchorCom.handleScrollTo();
      this.anchorCom.$emit('on-select', this.route);
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/anchor/src/anchor-link.vue"
