...
var cascader_panelvue_type_template_id_34932346_render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.menus, function(menu, index) {
      return _vm.elCascader.dropDownVisible
        ? _c("cascader-menu", {
            directives: [
              {
                name: "scroll",
            ...
            ref: "menu",
            refInFor: true,
            attrs: { index: "car_munu_" + index, nodes: menu }
          })
        : _vm._e()
    }),
    1
...
/* harmony default export */ var cascader_nodevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleMultiCheckChange: function handleMultiCheckChange(ev, checked) {
...
// EXTERNAL MODULE: external "@/lib/utils/shared"
var shared_ = __webpack_require__(81);
...
// EXTERNAL MODULE: external "@/lib/utils/aria-utils"
var aria_utils_ = __webpack_require__(87);
...
// CONCATENATED MODULE: ./packages/cascader-panel/src/directive.js
...
/* harmony default export */ var directive = ({
  bind: function bind(el, binding, vnode) {
    if (vnode.componentInstance.panel.$parent.$parent.highPerformance) {
      setTimeout(function () {
        // 获取滚动页面DOM
        var SCROLL_DOM = el.querySelector('.el-cascader-panel .el-cascader-menu__wrap');
...
/* harmony default export */ var cascader_panelvue_type_script_lang_js_ = ({
  ...
  methods: {
    handleScroll: function handleScroll(param, el, middlePosition) {
      this.dispatch('ElCascaderX', 'el.cascader.scroll', [param, el, middlePosition]);
    },
...
module.exports = require("@/lib/utils/shared");
...
module.exports = require("@/lib/utils/aria-utils");
