...
// EXTERNAL MODULE: ./packages/message/assets/info.svg
var info = __webpack_require__(99);
var info_default = /*#__PURE__*/__webpack_require__.n(info);

// EXTERNAL MODULE: ./packages/message/assets/success.svg
var success = __webpack_require__(100);
var success_default = /*#__PURE__*/__webpack_require__.n(success);

// EXTERNAL MODULE: ./packages/message/assets/warning.svg
var warning = __webpack_require__(101);
var warning_default = /*#__PURE__*/__webpack_require__.n(warning);

// EXTERNAL MODULE: ./packages/message/assets/error.svg
var error = __webpack_require__(102);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    typeImg: function typeImg() {
      ...
      switch (this.type) {
        case 'info':
          ...
          break;
        case 'success':
          img = success_default.a;
          break;
        case 'warning':
          img = warning_default.a;
          break;
        case 'error':
          img = error_default.a;
          break;
  ...
  methods: {
    destroyElement: function destroyElement() {
      ...
      this.$destroy(true);
      // 适配iframe 模式
      this.showTopWindow ? self.top.window.document.body.removeChild(this.$el) : this.$el.parentNode.removeChild(this.$el);
    },
...
var main_Message = function Message(options) {
  ...
  // 适配iframe 模式
  instance.showTopWindow ? self.top.window.document.body.appendChild(instance.vm.$el) : document.body.appendChild(instance.vm.$el);
