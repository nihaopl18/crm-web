...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    event_bus["a" /* EventBus */].$on('updatePopper', this.updatePosition);
  },
  ...
  methods: {
    ...
    doToggle: function doToggle() {
      if (this.$slots.reference && this.$slots.reference['0'].tag.indexOf('ElInput') > -1) {
        if (this.$slots.reference['0'].componentOptions.propsData.disabled) return;
      }
      if (this.$refs.reference && this.$refs.reference.className && this.$refs.reference.className.indexOf('is-disabled') > -1) {
        return;
      }
  ...
  destroyed: function destroyed() {
    ...
    Object(dom_["off"])(reference, 'focus', this.doShow);
    Object(dom_["off"])(reference, 'blur', this.doClose);
    Object(dom_["off"])(reference, 'mouseleave', this.handleMouseLeave);
    Object(dom_["off"])(reference, 'mouseenter', this.handleMouseEnter);
    Object(dom_["off"])(document, 'click', this.handleDocumentClick);
    event_bus["a" /* EventBus */].$off('updatePopper', this.updatePosition);
  }
});
