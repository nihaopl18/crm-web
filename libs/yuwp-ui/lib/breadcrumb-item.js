...
var render = function() {
  ...
  return _c("span", { staticClass: "el-breadcrumb__item" }, [
    ...
    _c("span", { staticClass: "el-breadcrumb__separator" }, [
      ...
      if (this.to) {
        if (!yufp.router) {
          ...
          if (typeof this.to === 'string') {
            yufp.router.to(this.to);
          } else {
            var routerId = this.to.routerId;
            var data = this.to.data;
            var rootId = this.to.rootId;
            yufp.router.to(routerId, data, rootId);
          }
        }
      }
    }
