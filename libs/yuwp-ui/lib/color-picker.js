        ...
        [
          ...
          _c("div", { staticClass: "el-color-dropdown__btns" }, [
            _c("span", { staticClass: "el-color-dropdown__value" }, [
              _vm._v(_vm._s(_vm.currentColor))
            ]),
            _c(
              "a",
              {
              ...
              [_vm._v(_vm._s(_vm.t("el.colorpicker.clear")))]
            ),
            _c(
              "button",
              {
              ...
              [_vm._v(_vm._s(_vm.t("el.colorpicker.confirm")))]
            )
          ])
        ],
        1
...
/* harmony default export */ var draggable = (function (element, options) {
  ...
  var moveFn = function moveFn(event) {
    if (options.drag) {
      ...
      // setTimeout("document.onmousemove = moveFn;", 30);
      setTimeout(function () {
        options.drag(event);
      }, 30);
    }
  ...
  element.removeEventListener('mousedown', downFn);
...
/* harmony default export */ var alpha_slidervue_type_script_lang_js_ = ({
  ...
  computed: {
    colorValue: function colorValue() {
      var alpha = this.color.get('alpha');
      var value = this.color.get('value');
      return { alpha: alpha, value: value };
    }
  },
