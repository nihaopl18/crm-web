...
// EXTERNAL MODULE: external "@/lib/utils/after-leave"
var after_leave_ = __webpack_require__(98);
...
var LoadingConstructor = external_vue_default.a.extend(loading["a" /* default */]);
...
LoadingConstructor.prototype.close = function () {
  ...
  Object(dom_["removeClass"])(this.target, 'el-loading-parent--hidden');
  after_leave_default()(this, function () {
    if (_this2.fullscreen && _this2.originalOverflow !== 'hidden') {
      document.body.style.overflow = _this2.originalOverflow;
    }
    if (_this2.fullscreen || _this2.body) {
      document.body.style.position = _this2.originalPosition;
    } else {
      _this2.target.style.position = _this2.originalPosition;
    }
  ...
  external_vue_default.a.nextTick(function () {
    _this.visible = false;
    // 解决使用服务方式调用loading，全屏锁定时，loading消失后页面无法滚动bug。author：taoting1.
    // zhangkun 恢复代码解决ie 浏览器关不掉问题
...
/* harmony default export */ var packages_loading = __webpack_exports__["default"] = ({
  install: function install(Vue) {
    Vue.use(directive["a" /* default */]);
    Vue.prototype.$loading = src;
  },

  directive: directive["a" /* default */],
  service: src
});
...
module.exports = require("@/lib/utils/after-leave");
