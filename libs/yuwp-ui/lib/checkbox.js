...
/* harmony default export */ var checkboxvue_type_script_lang_js_ = ({
  ...
  computed: {
    model: {
      ...
      set: function set(val) {
        if (this.isGroup) {
          ...
          this._checkboxGroup.min !== undefined && this._checkboxGroup.min <= this._checkboxGroup.value.length && val.length < this._checkboxGroup.min && (isLimitExceeded = true);
    ...
    isChecked: function isChecked() {
      ...
      } else if (Object.prototype.toString.call(this.model) === '[object String]' && this.isGroup) {
        return this.model.indexOf(this.label) > -1;
  ...
  methods: {
    ...
    handleChange: function handleChange(ev) {
      ...
      this.$emit('change', ev, ev.target.checked, !ev.target.checked);
      if (this.isGroup) {
        this.$nextTick(function () {
          _this.dispatch('ElCheckboxGroup', 'change', [_this._checkboxGroup.value, _this._checkboxGroup.oldValue]);
        });
      }
    }
  },
