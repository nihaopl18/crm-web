...
module.exports = require("@/lib/cascader-panel");
        ...
        [
          _c(
            "div",
            {
              ...
              ref: "popper",
              class: ["el-popover", "el-cascader__dropdown", _vm.popperClass]
            },
            [
...
// EXTERNAL MODULE: external "@/lib/cascader-panel"
var cascader_panel_ = __webpack_require__(103);
...
// EXTERNAL MODULE: external "@/lib/utils/types"
var types_ = __webpack_require__(29);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    checkedValue: function checkedValue(val, oldVal) {
      ...
      if (visible !== dropDownVisible) {
        ...
        if (visible) {
          this.$nextTick(function () {
            _this2.updatePopper();
            _this2.panel && _this2.panel.scrollIntoView();
          });
        } else {
          this.doDestroy();
        }
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/cascader/src/main.vue"
